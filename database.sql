...
REPLACE INTO `question` (`Question`, `Answer`, `ShowQuestion`) VALUES
...
REPLACE INTO `register` (`Register_number`, `ID`, `Examcenter`, `Date`, `Time`, `Coupon`, `Createat`) VALUES
...
REPLACE INTO `teamleader` (`Result_number`, `L`, `M`, `Exempt`) VALUES
	('1', '3', '3', 'true');

-- Dumping data for table tugreats.tu100: ~0 rows (approximately)
REPLACE INTO `tu100` (`Result_number`, `D`, `V`, `G`, `Exempt`) VALUES
	('1', '2', '2', '2', 'false');

-- Dumping data for table tugreats.tu101: ~0 rows (approximately)
REPLACE INTO `tu101` (`Result_number`, `H`, `Z`, `Y`, `C`, `T`, `Exempt`) VALUES
	('1', '3', '1', '1', '1', '1', 'false');

-- Dumping data for table tugreats.tu102: ~0 rows (approximately)
REPLACE INTO `tu102` (`Result_number`, `U`, `A`, `P`, `Exempt`) VALUES
	('1', '2', '2', '2', 'false');

-- Dumping data for table tugreats.tu103: ~0 rows (approximately)
REPLACE INTO `tu103` (`Result_number`, `I`, `S`, `O`, `Exempt`) VALUES
	('1', '3', '3', '3', 'true');

-- Dumping data for table tugreats.tu106: ~0 rows (approximately)
REPLACE INTO `tu106` (`Result_number`, `R`, `B`, `W`, `E`, `F`, `Exempt`) VALUES
	('1', '3', '3', '3', '3', '3', 'true');

-- Dumping data for table tugreats.users: ~2 rows (approximately)
REPLACE INTO `users` (`ID`, `name`, `password`, `Coupon`) VALUES
